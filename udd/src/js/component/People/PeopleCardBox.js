...
function PeopleCardBox(props) {
    return (

        <article
            className="post--card post--ajax  type-post status-publish format-standard has-post-thumbnail hentry category-stories"
            data-tags="[]"
        >
                ...
                <div className="post__details">
                    ...
                    <div className="post__info">
                        <time
                            ...
                            dateTime="2021-06-16T09:00:00+09:00"
                        >
